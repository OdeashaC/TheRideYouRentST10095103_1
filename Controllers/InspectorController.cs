...
namespace TheRideYouRentST10095103_1.Controllers
{
    public class InspectorController : Controller
    {
        ...
        public InspectorController(TheRideUrRentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inspectors != null ? 
                          ...
                          Problem("Entity set 'TheRideUrRentContext.Inspectors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'TheRideUrRentContext.Inspectors'  is null.");
            }
            var inspector = await _context.Inspectors.FindAsync(id);
            if (inspector != null)
            {
