...
namespace TheRideYouRentST10095103_1.Controllers
{
    public class CarMakeController : Controller
    {
        ...
        public CarMakeController(TheRideUrRentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CarMakes != null ? 
                          ...
                          Problem("Entity set 'TheRideUrRentContext.CarMakes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CarMakeId,CarMakeDescription")] CarMake carMake)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarMakeId,CarMakeDescription")] CarMake carMake)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheRideUrRentContext.CarMakes'  is null.");
            }
            var carMake = await _context.CarMakes.FindAsync(id);
            if (carMake != null)
            {
