...
namespace TheRideYouRentST10095103_1.Controllers
{
    public class DriverController : Controller
    {
        ...
        public DriverController(TheRideUrRentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Drivers != null ? 
                          ...
                          Problem("Entity set 'TheRideUrRentContext.Drivers'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DriverId,DriverName,DriverAddress,DriverEmail,DriverMobile")] Driver driver)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheRideUrRentContext.Drivers'  is null.");
            }
            var driver = await _context.Drivers.FindAsync(id);
            if (driver != null)
            {
