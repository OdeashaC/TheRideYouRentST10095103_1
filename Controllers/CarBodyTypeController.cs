...
namespace TheRideYouRentST10095103_1.Controllers
{
    public class CarBodyTypeController : Controller
    {
        ...
        public CarBodyTypeController(TheRideUrRentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CarBodyTypes != null ? 
                          ...
                          Problem("Entity set 'TheRideUrRentContext.CarBodyTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CarBodyTypeId,CarBodyTypeDescription")] CarBodyType carBodyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarBodyTypeId,CarBodyTypeDescription")] CarBodyType carBodyType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheRideUrRentContext.CarBodyTypes'  is null.");
            }
            var carBodyType = await _context.CarBodyTypes.FindAsync(id);
            if (carBodyType != null)
            {
